 ...
 * connected WhatsAppAccounts via the workspace). Connecting or re-keying a
 * number goes through /onboarding (Embedded Signup or manual token), which
 * stores the token on the account row. No mock registry.
 */
