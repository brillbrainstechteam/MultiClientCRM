...
/**
 * Shared renderer for representative system states driven by `?state=`. Screens
 * call this for their content area and fall through to the real body when it
 * returns null — so we don't clone whole pages per state (Batch 6 rule).
 *
